...
CREATE TABLE titles (
	...
	to_date DATE NOT NULL,
	FOREIGN KEY (emp_no) REFERENCES employees (emp_no),
	FOREIGN  (emp_no) REFERENCES salaries (emp_no),
...
--Shorthand Join from emp_info to add to_date and salary
DROP TABLE emp_info;
...
SELECT * FRPO-- List of managers per department
SELECT  dm.dept_no,
        d.dept_name,
        dm.emp_no,
        ce.last_name,
